...
function RegisterAdminOverlay(props) {
  const hideOverlay = (e) => {
  ...
  return (
    ...
    >
      <div className="w-[550px] h-auto bg-white rounded shadow">
        <div className="p-4">
          <h4 className="text-lg font-semibold pt-5 pb-4">
            Register new Credit Union Admin
          </h4>
          {/* {
      ...
      organizationMemberId: "90061",
      employeeId: "90061",
      deviceId: "45984985484958",
    }, */}
          <TextInput
...
export default RegisterAdminOverlay;
