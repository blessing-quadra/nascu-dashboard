...
import { DepositToBOWallet } from "../../Services/Deposit/AdminDepositService";
...
function Deposit() {
  ...
  const [data, setData] = useState({
    ...
    amount: "10",
    message: "Deposit into Branch Officer wallet",
  });
    ...
    promise
      .then((response) => {
        ...
        const filteredDeposit = responseBody?.contents.filter(
          (content) => content.financialTransactionType === "DEPOSIT"
        );
  ...
  const depositHandler = () => {
    const payload = {
      ...
      senderNote: data.message,
    };

    const promise = DepositToBOWallet(payload);
  ...
  const tableProps = {
    ...
    rows,
    icon: "",
    emptyDataText: "No Deposit data is available",
  };
  return (
      ...
      <div className="w-full sm:w-[calc(100%_-_230px)] flex items-start h-screen bg-white">
        ...
        <div className="middle-content w-full sm:w-[calc(100%_-_240px)] p-6">
          ...
          <div className="transactions py-4">
            <div className="flex justify-between flex-col sm:flex-row items-start sm:items-center my-4">
