  ...
  const filterHandler = (e) => {
    if (e.target.value.length > 2) {
      ...
      switch (selectedFilterProperties) {
        case "firstName":
          newFilteredData = membersData.filter(
            (eachData) =>
              eachData.firstName.toLowerCase().indexOf(e.target.value) > -1
          );
          break;
        ...
        case "organizationShortName":
          ...
          newFilteredData = membersData.filter(
            (eachData) =>
              eachData.organizationShortName.toLowerCase().indexOf(e.target.value) >
              -1
          );
          break;
