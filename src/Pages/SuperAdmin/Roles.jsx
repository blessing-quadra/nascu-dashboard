...
function Roles() {
  ...
  const [data, setData] = useState({
    ...
    message: "Description about the role",
  });
  ...
  useEffect(() => {
    ...
    const fetchRolesPromise = FetchAllRoles();
  ...
  const viewPermissionsOfRole = (id) => {
    setSelectedRoleIndex(id);
    setIsUserSelected(true);
  };

  const savePermissionsHandler = () => {
    console.log(selectedPermissionsList);
  }
              ...
              {isUserSelected ? (
                <div className="pt-5">
                  ...
                  <p className="text-sm text-gray-500 my-3">
                    ...
                    {rolesData[selectedRoleIndex].accessTypeDescription}
                  </p>
                    ...
                    {rolesData?.map(({ name }, index) => (
                      <div className="h-auto my-3 sm:my-0 sm:h-12 hover:bg-blue-50 rounded flex flex-col sm:flex-row justify-between items-start gap-2 sm:gap-0 sm:items-center">
                        ...
                        <span
                          ...
                          onClick={() => viewPermissionsOfRole(index)}
                        >
                          View permissions
                        </span>
                      </div>
